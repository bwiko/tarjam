...
* make shortcut key to Tarjam command : 
  1. #### go to settings>keyboard>Application Shortcut :
     <img src="./img/1.png" alt="logo" width="340" height="650"/>&nbsp;&nbsp;&nbsp;&nbsp;<img src="./img/2.png" alt="logo" width="340" height="650"/><br>
  3. #### press add then `tarjam -a` as command then choose your shortcut for translat to arabic :
     <img src="./img/4.png" alt="logo" width="340" height="650"/><br>
  3. #### press add then `tarjam -e` as command then choose your shortcut for translat to english :
     <img src="./img/5.png" alt="logo" width="340" height="650"/><br>
  ...
  7. #### demo : 
     <img src="./img/8.png" alt="logo" width="502" height="580"/><br>
